# @lemn-ltd/showcase-kit

`@lemn-ltd/showcase-kit` provides the shared browser-only harness for the canonical design-system showcase.
...
- `@lemn-ltd/showcase-kit/styles.css` for harness chrome.
