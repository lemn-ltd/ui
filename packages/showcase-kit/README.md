...
`@lemn-ltd/showcase-kit` owns browser-only, brand-neutral showcase harness primitives and registry plumbing.
...
- CSS for the harness chrome ships through `@lemn-ltd/showcase-kit/styles.css`.
