...
function ModeProbe(): ReactElement {
  ...
  return (
    <>
      ...
      <button data-testid="set-rail" onClick={() => shell?.sidebar.setMode('rail')} type="button">
        rail
      </button>
    </>
  );
...
describe('ScreenShell', () => {
  ...
  it('renders the sidebar, topbar and content slot nodes in their regions', () => {
    const { container } = render(
      <ScreenShell sidebar={<div data-testid="sidebar" />} topBar={<div data-testid="topbar" />}>
        <div data-testid="content" />
      </ScreenShell>,
    );
    expect(
      container.querySelector('.ui-screen-shell__sidebar [data-testid="sidebar"]'),
    ).not.toBeNull();
    expect(
      container.querySelector('.ui-screen-shell__topbar [data-testid="topbar"]'),
    ).not.toBeNull();
    expect(
      container.querySelector('.ui-screen-shell__content [data-testid="content"]'),
    ).not.toBeNull();
  });
  ...
  it('closes the open mobile drawer on Escape', () => {
    ...
    pressCmdB();
    expect(container.querySelector('.ui-screen-shell__backdrop')).not.toBeNull();
    act(() => {
