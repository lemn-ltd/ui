    ...
    >
        {GROUPS.map((group) => (
          <PageSection key={group.title} title={group.title}>
            <div className="portal-swatch-grid">
              {group.swatches.map((swatch) => (
                <div className="portal-swatch" key={swatch.cssVar}>
                  <div
                    className="portal-swatch__chip"
                    style={{ background: `var(${swatch.cssVar})` }}
                  />
                  <div className="portal-swatch__label">{swatch.label}</div>
                  <div className="portal-swatch__var">{swatch.cssVar}</div>
                </div>
              ))}
            </div>
          </PageSection>
