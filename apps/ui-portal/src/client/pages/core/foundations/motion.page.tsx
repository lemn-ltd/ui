    ...
    >
        <PageSection title="Durations">
          {DURATIONS.map((duration) => (
            <div className="portal-token-row" key={duration.label}>
              <span className="portal-token-name">{duration.label}</span>
              <span className="portal-token-value">{duration.value}</span>
            </div>
          ))}
        </PageSection>
        ...
        <PageSection title="Easings">
          {EASINGS.map((easing) => (
            <div className="portal-token-row" key={easing.label}>
              <span className="portal-token-name">{easing.label}</span>
              <span className="portal-token-value">{easing.value}</span>
            </div>
          ))}
        </PageSection>

        <PageSection title="Loops">
          <div className="portal-motion-loops">
            <Spinner />
            <Skeleton shape="line" />
