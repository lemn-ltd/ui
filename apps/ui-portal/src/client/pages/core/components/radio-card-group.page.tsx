			...
			<RadioCardGroup
				...
				options={[
					...
					},
					{
						...
						description: "Delivered every Monday.",
			...
			apiRows={[
				{
					...
					description: "Value, label, description, icon, and disabled state.",
				},
				{
					prop: "value / defaultValue",
					type: "string",
					description: "Controlled or initial selected card.",
				},
				{
					prop: "onValueChange",
				...
				},
				{
					...
					description: "Card layout and Radix navigation axis.",
				},
				{
					prop: "name",
					type: "string",
					description: "Form field name forwarded to the radio group.",
				},
				{
					prop: "required",
					type: "boolean",
					defaultValue: "false",
					description: "Marks the radio choice as required.",
				},
				{
					prop: "disabled",
					type: "boolean",
