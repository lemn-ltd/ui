...
import {
	disabledAgentEntry as componentEntry,
	type DisabledAgentSourceEntry,
} from "../disabled-agent-entry.js";
...
const ExecutionMapPage = lazy(
	() => import("../../pages/agents/components/execution-map.page.js"),
);
...
const CapabilityConstraintsEditorPage = lazy(
	() =>
		import(
			"../../pages/agents/components/capability-constraints-editor.page.js"
		),
);
const PrincipalPickerPage = lazy(
	() => import("../../pages/agents/components/principal-picker.page.js"),
);
const ApprovalCardPage = lazy(
	() => import("../../pages/agents/components/approval-card.page.js"),
);
...
const TriggerTilePage = lazy(
	() => import("../../pages/agents/components/trigger-tile.page.js"),
);
...
const RunTimelinePage = lazy(
	() => import("../../pages/agents/components/run-timeline.page.js"),
);
...
export const agentsEntries: DisabledAgentSourceEntry[] = [
	...
	componentEntry("capability-constraints-editor", () => (
		<CapabilityConstraintsEditorPage />
	)),
	...
	componentEntry("effective-surface-viewer", () => (
		<EffectiveSurfaceViewerPage />
	)),
	componentEntry("automation-status-badge", () => (
		<AutomationStatusBadgePage />
	)),
