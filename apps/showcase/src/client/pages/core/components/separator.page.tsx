			...
			apiRows={[
				{
					...
					description: "Visual and semantic axis.",
				},
				{
					prop: "decorative",
					type: "boolean",
					defaultValue: "true",
					description:
						"Uses presentation semantics unless the division is meaningful.",
				},
				{
					prop: "className",
					type: "string",
					description: "Additional styling hook without implicit layout.",
				},
				{
					prop: "native div attributes",
					type: "HTMLAttributes<HTMLDivElement>",
					description:
						"Native attributes except role, which follows decorative semantics.",
				},
			]}
			category="Layout"
			code={CODE}
