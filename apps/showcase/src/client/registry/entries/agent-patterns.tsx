...
const AgentSessionPage = lazy(() => import('../../pages/agents/patterns/agent-session.page.js'));
const AutomationBuilderPage = lazy(
  () => import('../../pages/agents/patterns/automation-builder.page.js'),
);
const RunMonitorPage = lazy(() => import('../../pages/agents/patterns/run-monitor.page.js'));

export const agentPatternsEntries: ShowcaseEntry[] = [
  {
    area: 'agents',
    slug: 'agent-session',
    title: 'Agent session',
