...
const DialogPage = lazy(() => import('../../pages/core/components/dialog.page.js'));
const DrawerPage = lazy(() => import('../../pages/core/components/drawer.page.js'));
const MarkdownViewerPage = lazy(
  () => import('../../pages/core/components/markdown-viewer.page.js'),
);
const ConfirmDialogPage = lazy(() => import('../../pages/core/components/confirm-dialog.page.js'));
const FormDialogPage = lazy(() => import('../../pages/core/components/form-dialog.page.js'));
const MenuPage = lazy(() => import('../../pages/core/components/menu.page.js'));
const PopoverPage = lazy(() => import('../../pages/core/components/popover.page.js'));
const TooltipPage = lazy(() => import('../../pages/core/components/tooltip.page.js'));
const HintIconPage = lazy(() => import('../../pages/core/components/hint-icon.page.js'));
