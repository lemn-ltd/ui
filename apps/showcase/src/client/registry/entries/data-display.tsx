...
const SettingsRowPage = lazy(() => import('../../pages/core/components/settings-row.page.js'));
const DescriptionListPage = lazy(
  () => import('../../pages/core/components/description-list.page.js'),
);
const DataTablePage = lazy(() => import('../../pages/core/components/data-table.page.js'));
const StatCardPage = lazy(() => import('../../pages/core/components/stat-card.page.js'));
const StatsStripPage = lazy(() => import('../../pages/core/components/stats-strip.page.js'));
const CodeBlockPage = lazy(() => import('../../pages/core/components/code-block.page.js'));
const SyntaxCodeBlockPage = lazy(
  () => import('../../pages/core/components/syntax-code-block.page.js'),
);
const JsonViewerPage = lazy(() => import('../../pages/core/components/json-viewer.page.js'));
const MarkdownPage = lazy(() => import('../../pages/core/components/markdown.page.js'));
const SparklinePage = lazy(() => import('../../pages/core/components/sparkline.page.js'));
const RelativeTimePage = lazy(() => import('../../pages/core/components/relative-time.page.js'));
const ListShellPage = lazy(() => import('../../pages/core/components/list-shell.page.js'));
const ListFiltersBarPage = lazy(
  () => import('../../pages/core/components/list-filters-bar.page.js'),
);
const FilterPage = lazy(() => import('../../pages/core/components/filter.page.js'));
const FilterChipPage = lazy(() => import('../../pages/core/components/filter-chip.page.js'));
const EmptyStatePage = lazy(() => import('../../pages/core/components/empty-state.page.js'));
const RecentChipsPage = lazy(() => import('../../pages/core/components/recent-chips.page.js'));
